...
//    [_btnFlash addTarget:self action:@selector(openOrCloseFlash) forControlEvents:UIControlEventTouchUpInside];
    ...
    [_btnMyQR setImage:[UIImage imageNamed:@"CodeScan.bundle/qrcode_scan_btn_flash_nor"] forState:UIControlStateNormal];
    [_btnMyQR setImage:[UIImage imageNamed:@"CodeScan.bundle/qrcode_scan_btn_flash_down"] forState:UIControlStateHighlighted];
    [_btnMyQR addTarget:self action:@selector(openOrCloseFlash) forControlEvents:UIControlEventTouchUpInside];
...
- (void)scanResultWithArray:(NSArray<LBXScanResult*>*)array
{
   ...
   // [LBXScanWrapper systemVibrate];
    ...
    if(self.codeblock){
        self.codeblock(scanResult.strScanned);
    }
    [self.navigationController popViewControllerAnimated:YES];
